                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link text-white" href="lista.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-list-ol text-white"></i></div>
                                Postulantes
                            </a>
                                ...
                                <table id="datatablesSimple" class="table table-sm" data-page-length="25">
                                    ...
                                    <thead class="encabezado">
                                        <tr>
                                            ...
                                            <th>C.I.</th>
                                            <th>Edad</th>
                                            <th class="table-dark text-center text-white acciones">Acciones</th>
                                    ...
                                    <tbody>
                                        <?php while($row = $resultado->fetch_assoc()){ ?>
                                            <tr>
                                                ...
                                                <a href="../util/edit.php?id=<?php echo($row['id']) ?>"><img class="tamIconos" src="../iconos/01_Editar.svg" alt="Edit"></a>
                                                <a href="../util/delete.php?id=<?php echo($row['id']) ?>"><img class="tamIconos" src="../iconos/02_Eliminar.svg" alt="Delete"></a>
                                                <a target="_blank" href="../prints/print.php?id=<?php echo($row['id']) ?>"><img class="tamIconos" src="../iconos/03_Imprimir.svg" alt="Print"></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
