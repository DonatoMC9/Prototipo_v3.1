                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link text-white" href="eval_comp.php">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header text-white rotulo">
                                ...
                                Postulantes - Evaluación de Competencias
                            </div>

                            <div class="card-body">

                                <!-- Tabla -->
                                <table id="datatablesSimple" class="table table-sm" data-page-length="25">
                                    ...
                                    <thead class="encabezado">
                                        <tr>
                                            ...
                                            <th>Ape. Materno</th>
                                            <th>C.I.</th>                                            
                                            <th class="table-dark text-white estados encabezado_acciones">Estado CD</th>
                                            <th class="table-dark text-center text-white acciones estados">Evaluar CD</th>
                                            <th class="table-dark text-white estados">Estado CB</th>
                                            <th class="table-dark text-center text-white acciones estados">Evaluar CB</th>
                                    ...
                                    <tbody>
                                        <?php while($row = $resultado->fetch_assoc()){ ?>
                                            <tr>
                                                ...
                                                <td class="table-warning text-center"><?php echo $row['estado_CD']; ?></td>
                                                <td class="table-warning text-center">
                                                <a href="../util/eval_cd.php?id=<?php echo($row['id']) ?>"><img class="tamIconos" src="../iconos/04_Evaluar.svg" alt="Edit"></a></td>

                                                <td class="table-info text-center"><?php echo $row['estado_CB']; ?></td>
                                                <td class="table-info text-center">
                                                <a href="../util/eval_cb.php?id=<?php echo($row['id']) ?>"><img class="tamIconos" src="../iconos/05_Evaluar.svg" alt="Edit"></a></td>
